...
import { loginInitiate, selectUser, signInWithGoogleInitiate } from '../../../features/auth/authSlice';
import {
    Form,
    FormButton,
    FormButtonGoogle,
...
const Login = () => {
    ...
    return (
        <Form onSubmit={handleLogin}>
            ...
            <FormGroup>
                <FormInput type="email" name="email" id="emailLogin" value={email} onChange={handleChange} required />
